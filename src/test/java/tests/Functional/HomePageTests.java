...
public class HomePageTests extends BaseTest {
    ...
    public void VerifySubscribeEmailInHomePage() throws InterruptedException {
        ...
        Assert.assertTrue(homePage.isEmailSubmitIconDisplayed(), "Email Submit Button is not displayed");
    ...
    public void VerifyScrollToTopIconInHomePage() throws InterruptedException {
        ...
        Assert.assertTrue(homePage.isHomePageLogoDisplayed(), "Subscription Form is not displayed");
    }
    ...
    public void VerifyNavigationToVideoTutorialsPage() throws InterruptedException {
        ...
        Assert.assertTrue(driver.getCurrentUrl().endsWith("AutomationExercise"),"Video Tutorial page is not displayed");
    }
}
